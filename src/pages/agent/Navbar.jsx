...
const Navbar = ({ className }) => {
  ...
  const navItems = () => {
    ...
    const items = {
      ...
      "/agent/add-Properties": "Add Properties",
      "/agent/my-properties": "My Properties",
      "/agent/sold-properties": "Sold Properties",
      "/agent/requested-properties": "Requested Properties",
    };
