  ...
  return (
    <>
      <section className="bg-gray-900 text-white py-24 px-6">
        <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row gap-16 items-center justify-between">
          {/* Left Content */}
          ...
          {/* Right Content */}
          <div className="w-full bg-white text-gray-800 p-6 rounded shadow-md mt-8 lg:mt-0">
